    ...
    <main>
      <section className="hero-about">
        <div className="hero-content">
          <h1>À Propos de Prestige Car BNS</h1>
          <p>Votre partenaire de confiance pour un transport d'exception</p>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="about-section">
            ...
            <div className="values-grid">
              ...
              <div className="value-item">
                <h3>✨ Excellence</h3>
                <p>Véhicules haut de gamme et chauffeurs professionnels expérimentés</p>
              </div>
              <div className="value-item">
                <h3>🤝 Proximité</h3>
